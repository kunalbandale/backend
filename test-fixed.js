...
async function testBulkDocumentRoute() {
  console.log('🧪 Testing bulk document route with trailing spaces fix...');
  ...
  try {
    ...
    // Add form fields (with trailing spaces to test the fix)
    form.append('operationName', 'Test Bulk Document');
    form.append('caption ', 'Test document caption'); // Note the trailing space
    form.append('department ', 'Department 1'); // Note the trailing space
    
    console.log('Sending request with trailing spaces...');
...
async function testSingleDocumentRoute() {
  ...
  try {
    ...
    console.log('Sending single document request...');
